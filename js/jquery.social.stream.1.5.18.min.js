...
(function($_jss) {
  ...
  $_jss.extend(SocialStreamObject.prototype, {
    version: '1.5.18',
    create: function(el, options) {
      ...
      this.o = {}, this.timer_on = 0, this.id = 'dcsns-' + $_jss(el).index(), this.timerId = '', this.o = $_jss.extend(true, this.defaults, options), opt = this.o, $_jssload = $_jss('<div class="dcsns-loading">creating stream ...</div>');
